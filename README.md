...
<details>
<summary> <b> 상세 기술 스택 및 버전</b> </summary>
...
|                               메인 화면 (PC)                                |
| :-------------------------------------------------------------------------: |
| <img src="./readme_assets/forestkeeper_home_pc.gif" alt="메인 화면 (PC)" /> |
...
- 플로깅 진행하고 나서 결과를 확인할 수 있으며,  
  주운 쓰레기를 카메라로 찍어 쓰레기 종류 분석을 통해 경험치를 적립할 수 있다.
...
- 산별로 날짜 및 인원 수를 지정하여 플로깅 팀원 모집 글을 등록할 수 있으며,  
  원하는 플로깅 팀원 모집 글이 있을 경우 신청을 통해 플로깅에 참가한다.
