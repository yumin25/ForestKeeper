    ...
    <div style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
      ...
      <div style={{ height: "30vh", backgroundColor: "white", display: "flex" }}>
        ...
        <div style={{ marginRight: "3vw", padding: "11vw 0", width: "60vw" }}>
          ...
          <div style={{ fontSize: "2vw", marginTop: "3vh" }}>숲지기 어플에선 산의 정보를 찾을 수 있고.</div>
          <div style={{ fontSize: "2vw" }}>명예의 전당에서 누가 플로깅을 많이 했나</div>
          <div style={{ fontSize: "2vw" }}>확인할 수 있어요.</div>
          <div style={{ fontSize: "2vw" }}>플로깅 횟수로도, 경험치로도</div>
          <div style={{ fontSize: "2vw" }}>확인할 수 있답니다.</div>
        </div>
      </div>
      <div style={{ height: "30vh", backgroundColor: "#EAEAEA", display: "flex" }}>
        <div style={{ margin: "0 3vw", padding: "18vw 0 0 5vw", width: "60vw" }}>
          ...
          <div style={{ fontSize: "2vw", marginTop: "3vh" }}>혼자 산에 가서 플로깅하기엔 조금 부끄럽다고요?</div>
          <div style={{ fontSize: "2vw" }}>함께 플로깅할 친구를 모집할 수 있답니다.</div>
          <div style={{ fontSize: "2vw" }}>원하는 시간, 원하는 동료와 함께 줍줍!</div>
        </div>
      ...
      <div style={{ height: "30vh", backgroundColor: "white", display: "flex" }}>
        ...
        <div style={{ marginRight: "3vw", padding: "13vw 0", width: "60vw" }}>
          ...
          <div style={{ fontSize: "2vw", marginTop: "3vh" }}>어떤 쓰레기를 주웠나 인증 고고!</div>
          <div style={{ fontSize: "2vw" }}>주운 쓰레기의 양과 종류에 따라</div>
          <div style={{ fontSize: "2vw" }}>경험치가 부여된답니다.</div>
          <div style={{ fontSize: "2vw" }}>마이페이지에서 지난 기록까지</div>
          <div style={{ fontSize: "2vw" }}>한눈에 확인해보자구요~</div>
        </div>
      </div>
